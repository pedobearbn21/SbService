    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.IntegerField(default=0)),
                ('meat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.meat')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meat', models.ManyToManyField(through='customer.OrderReciept', to='customer.Meat')),
